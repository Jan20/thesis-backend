...
class LevelSetup(object):
    ...
    def initialize_levels(self):
        ...
        tutorial: Level = Level('tutorial', 'tutorial', TextFileReader().read_text_file('tutorial.txt'))
        ...
        level_01 = evolution.evolve('random_distribution', 100, level_01)
        level_02 = evolution.evolve('random_distribution', 100, level_02)
        level_03 = evolution.evolve('random_distribution', 100, level_03)
        level_04 = evolution.evolve('random_distribution', 100, level_04)
        level_05 = evolution.evolve('random_distribution', 100, level_05)
        level_06 = evolution.evolve('random_distribution', 100, level_06)
        level_07 = evolution.evolve('random_distribution', 100, level_07)
        level_08 = evolution.evolve('random_distribution', 100, level_08)
